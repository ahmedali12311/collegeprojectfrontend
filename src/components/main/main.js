...
<motion.div className="stat-card" variants={cardVariants}>
  <h3>
    <AnimatedStat targetValue={statistics.studentCount} />+
  </h3>
  <p>الطلاب الحاليين</p>
</motion.div>
...
<motion.div className="stat-card" variants={cardVariants}>
  <h3>
    <AnimatedStat targetValue={statistics.graduationStudentCount} />
  </h3>
...
<motion.div className="stat-card" variants={cardVariants}>
  <h3>
    <AnimatedStat targetValue={statistics.booksCount} />
  </h3>
  <p>مشروع</p>
</motion.div>
      </motion.section>
