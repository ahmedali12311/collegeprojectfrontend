...
const Users = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("graduation_semester", formData.graduation_semester ? true : false); // Send true if checked, false if not
...
{isFormVisible && (
  ...
  {errors.role && <div className="error-message">{errors.role}</div>}
    ...
    {/* Graduation Semester Field */}
    <div className="graduation-semester-container">
      <label className="graduation-checkbox">
        <input
          type="checkbox"
          name="graduation_semester"
          checked={formData.graduation_semester || false}
          onChange={(e) =>
            setFormData((prevData) => ({
              ...prevData,
      ...
      <span className="graduation-label">طالب في فصل التخرج</span>
    </div>

    <div className="form-column">
      <div className={`form-group ${errors.image ? "error-label" : ""}`}>
        <label>
          صورة (اختياري)
          <div className="file-upload">
            <span>{formData.image ? formData.image.name : "اختر صورة"}</span>
